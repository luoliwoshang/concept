; ModuleID = 'busy_wait_demo.c'
source_filename = "busy_wait_demo.c"
...
define void @signal_handler(i32 %0) #0 {
  store i32 1, ptr @flag, align 4, !tbaa !6
...
define noundef i32 @main() local_unnamed_addr #2 {
  ...
  %4 = load i32, ptr @flag, align 4, !tbaa !6
  %5 = icmp eq i32 %4, 0
...
15:                                               ; preds = %7
  ...
  %18 = load i32, ptr @flag, align 4, !tbaa !6
  br label %19
